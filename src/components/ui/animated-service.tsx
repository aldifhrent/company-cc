          ...
          <div className="relative h-80 w-full">
            <AnimatePresence>
              {services.map((service: any, index) => {
                // Debugging: Log the image URL instead of using alert
                const imageUrl =
                  (service.fields.image[0].fields.file.url as string) ||
                  undefined;
                ...
                return (
                  ...
                  >
                    <Image
                      src={`https:${imageUrl ?? ""}`} // Provide fallback if URL is undefined
                      alt={service.fields.title ?? "Service Image"} // Provide fallback if title is undefined
                      width={500}
                      height={500}
                      draggable={false}
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <motion.p className="text-md text-gray-500 mt-2 dark:text-neutral-300">
              {services[active].fields.description
                .split(" ")
                .map((word, index) => (
                  <motion.span
                    key={index}
